...
'''
# 配置测试接口名称
case_name = "test_hardware_network_flow"
# 配置excel表格名称
...
class Test_hardware_network_flow(unittest.TestCase):
    ...
    def test_hardware_network_flow_01(self):
    ...
    def test_hardware_network_flow_02(self):
    ...
    def test_hardware_network_flow_03(self):
    ...
    def test_hardware_network_flow_04(self):
    ...
    def test_hardware_network_flow_05(self):
    ...
    def test_hardware_network_flow_06(self):
    ...
    def test_hardware_network_flow_07(self):
