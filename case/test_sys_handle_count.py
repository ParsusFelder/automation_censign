...
'''
# 配置测试接口名称
case_name = "test_sys_handle_count"
# 配置excel表格名称
...
class Test_sys_handle_count(unittest.TestCase):
    ...
    def test_sys_handle_count_01(self):
        ...
        try:
            ...
            self.assertNotEqual(result['data']['filemax'], None, test_case[0] + ":测试失败,data错误")
            self.assertNotEqual(result['data']['unused'], None, test_case[0] + ":测试失败,data错误")
            self.assertNotEqual(result['data']['allocated'], None, test_case[0] + ":测试失败,data错误")
    ...
    def test_sys_handle_count_02(self):
        ...
        try:
            ...
            self.assertEqual(result['data']['filemax'], None, test_case[0] + ":测试失败,data错误")
            self.assertEqual(result['data']['unused'], None, test_case[0] + ":测试失败,data错误")
            self.assertEqual(result['data']['allocated'], None, test_case[0] + ":测试失败,data错误")
    ...
    def test_sys_handle_count_03(self):
    ...
    def test_sys_handle_count_04(self):
    ...
    def test_sys_handle_count_05(self):
    ...
    def test_sys_handle_count_06(self):
    ...
    def test_sys_handle_count_07(self):
