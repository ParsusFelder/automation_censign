...
'''
# 配置测试接口名称
case_name = "test_hardware_fans_speed"
# 配置excel表格名称
...
class Test_hardware_fans_speed(unittest.TestCase):
    ...
    def test_hardware_fans_speed_01(self):
    ...
    def test_hardware_fans_speed_02(self):
    ...
    def test_hardware_fans_speed_03(self):
    ...
    def test_hardware_fans_speed_04(self):
    ...
    def test_hardware_fans_speed_05(self):
    ...
    def test_hardware_fans_speed_06(self):
    ...
    def test_hardware_fans_speed_07(self):
