...
'''
# 配置测试接口名称
case_name = "test_service_response_time"
# 配置excel表格名称
...
class TestServiceResponseTime(unittest.TestCase):
    ...
    def test_service_response_time_01(self):
    ...
    def test_service_response_time_02(self):
    ...
    def test_service_response_time_03(self):
    ...
    def test_service_response_time_04(self):
    ...
    def test_service_response_time_05(self):
    ...
    def test_service_response_time_06(self):
    ...
    def test_service_response_time_07(self):
    ...
    def test_service_response_time_08(self):
    ...
    def test_service_response_time_09(self):
    ...
    def test_service_response_time_10(self):
