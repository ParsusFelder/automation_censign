...
class Test_sys_shell_top(unittest.TestCase):
    ...
    def test_sys_shell_top_01(self):
        ...
        try:
            ...
            self.assertNotEqual(result['data']['top'], None, test_case[0] + ":测试失败,data错误")
    ...
    def test_sys_shell_top_02(self):
        ...
        try:
            ...
            self.assertEqual(result['data']['top'], None, test_case[0] + ":测试失败,data错误")
    ...
    def test_sys_shell_top_03(self):
    ...
    def test_sys_shell_top_04(self):
    ...
    def test_sys_shell_top_05(self):
    ...
    def test_sys_shell_top_06(self):
    ...
    def test_sys_shell_top_07(self):
