...
class TestSysCpuUsage(unittest.TestCase):
    ...
    def test_sys_cpu_usage_01(self):
        ...
        try:
            ...
            self.assertNotEqual(result['data']['usr_cpu'], None, test_case[0] + ":测试失败,data错误")
            self.assertNotEqual(result['data']['sys_cpu'], None, test_case[0] + ":测试失败,data错误")
    ...
    def test_sys_cpu_usage_02(self):
        ...
        try:
            ...
            self.assertEqual(result['data']['usr_cpu'], None, test_case[0] + ":测试失败,data错误")
            self.assertEqual(result['data']['sys_cpu'], None, test_case[0] + ":测试失败,data错误")
    ...
    def test_sys_cpu_usage_03(self):
    ...
    def test_sys_cpu_usage_04(self):
    ...
    def test_sys_cpu_usage_05(self):
    ...
    def test_sys_cpu_usage_06(self):
    ...
    def test_sys_cpu_usage_07(self):
